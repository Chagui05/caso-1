...
public:
    News(string pAuthor, string pTitle, string pContent)
    {
        this->author = pAuthor;
        this->title = pTitle;
...
public:
    vector<News *> getRecords()
    {
        ...
        string url = "https://newsapi.org/v2/everything?q=election&from=2023-08-29&sortBy=popularity&apiKey=2504f86f69c548edb81b3bb8afe3f2cb";
...
int main(void)
{
    ...
    for(int i = 0 ; i<15 ; i++){
        cout << allrecords.at(i)->getTitle() << endl;
    }
    cout << "sirve"<< endl;
    return 0;
}
